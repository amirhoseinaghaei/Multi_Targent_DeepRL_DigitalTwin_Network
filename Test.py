  ...
  for bit in bits:
    for rew in reward_mode:
      for ch in channelList:
        ...
        policy[1].load(f"{1}th PS", f"./pytorch_models/5ps_{bit}_{ch}_withpower_{rew}")
        policy[2].load(f"{2}th PS", f"./pytorch_models/5ps_{bit}_{ch}_withpower_{rew}")
        policy[3].load(f"{3}th PS", f"./pytorch_models/5ps_{bit}_{ch}_withpower_{rew}")
        policy[4].load(f"{4}th PS", f"./pytorch_models/5ps_{bit}_{ch}_withpower_{rew}")
        policy[5].load(f"{5}th PS", f"./pytorch_models/5ps_{bit}_{ch}_withpower_{rew}")
