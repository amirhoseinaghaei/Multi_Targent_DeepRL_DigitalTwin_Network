...
if Test == True:
  ...
  policy[1].load(f"{1}th PS", f"./pytorch_models/5ps_15ch_centralcritic_100bits_35w_70d_2")
  policy[2].load(f"{2}th PS", f"./pytorch_models/5ps_15ch_centralcritic_100bits_35w_70d_2")
  policy[3].load(f"{3}th PS", f"./pytorch_models/5ps_15ch_centralcritic_100bits_35w_70d_2")
  policy[4].load(f"{4}th PS", f"./pytorch_models/5ps_15ch_centralcritic_100bits_35w_70d_2")
  policy[5].load(f"{5}th PS", f"./pytorch_models/5ps_15ch_centralcritic_100bits_35w_70d_2")
  ...
  plt.figure(1)
  plt.title("AoI change with cooperative RL algorithm")
  plt.plot(AoI_dict["1"] , label = "ps1")
  plt.plot(AoI_dict["2"] , label = "ps2")
  plt.plot(AoI_dict["3"] , label = "ps3")
  plt.plot(AoI_dict["4"] , label = "ps4")
  plt.plot(AoI_dict["5"] , label = "ps5")
  ...
  plt.legend(loc = "best")
  plt.figure(2)
  plt.title("AoI change with random selection")
  plt.plot(AoI_dictRandom["1"] , label = "ps1")
  plt.plot(AoI_dictRandom["2"] , label = "ps2")
  plt.plot(AoI_dictRandom["3"] , label = "ps3")
  plt.plot(AoI_dictRandom["4"] , label = "ps4")
  plt.plot(AoI_dictRandom["5"] , label = "ps5")
